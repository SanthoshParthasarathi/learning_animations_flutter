...
class _TripListState extends State<TripList> {
  ...
  void initState() {
    super.initState();
    //this widgetsBinding.instance.addpostframecallback is used to first run the widget build
    // then fire the function inside it
    ...
    _trips.forEach((Trip trip) {
      _future = _future.then((_) {
        return Future.delayed(const Duration(milliseconds: 100), () {
          ...
          ///the below line is for adding animation to each widget to their current array state length..
